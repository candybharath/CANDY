...
from info import AUTH_CHANNEL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORTLINK_URL, SHORTLINK_API, LOG_CHANNEL, CUSTOM_FILE_CAPTION, LOGIN_CHANNEL
    ...
    for file in files:
        ...
        await bot.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/nasrani_update"),
                    InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url="https://t.me/NasraniSeries")
                ],[
